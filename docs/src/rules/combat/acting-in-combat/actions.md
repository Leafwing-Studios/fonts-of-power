...
Make an Expertise skill check, with the skill selected from Anima, Arcana, Craftsmanship, Fontcraft, Humanities or Tinkering, based on the creature or vantage selected.
