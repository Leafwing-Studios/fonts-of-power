...
**Effects:** 2 AP, 3 essence spells. 3 tile range, 1 tile radius, half effect on miss. Pick a subclass. The plurality of concoctions known must be from that list.
...
**Effects:** When you use the Catalyze action, provoke an attack of opportunity.

### Twist: Vessel

**Level:** 1

**Effects:** Choose a targeting-modifying metamagic.

### Supply and Demand

**Level:** 2

**Effects:** Ignore up to 2 points of negative loyalty towards you.
...
**Effects:** Gain the metamagic associated with your subclass.
...
**Effects:** Choose a complex metamagic.
...
**Effects:** Gain a subclass specific effect whenever you use the Activate action.
